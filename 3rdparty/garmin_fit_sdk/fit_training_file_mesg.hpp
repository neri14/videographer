...
public:
    ...
    FIT_BOOL IsFaveroProductValid() const
    {
        ...
        if( !CanSupportSubField( field, (FIT_UINT16) Profile::TRAINING_FILE_MESG_PRODUCT_FIELD_FAVERO_PRODUCT ) )
        {
            return FIT_FALSE;
        }

        return field->IsValueValid(0, (FIT_UINT16) Profile::TRAINING_FILE_MESG_PRODUCT_FIELD_FAVERO_PRODUCT);
    }
    ...
    {
        return GetFieldUINT16Value(2, 0, (FIT_UINT16) Profile::TRAINING_FILE_MESG_PRODUCT_FIELD_FAVERO_PRODUCT);
    }
    ...
    {
        SetFieldUINT16Value(2, faveroProduct, 0, (FIT_UINT16) Profile::TRAINING_FILE_MESG_PRODUCT_FIELD_FAVERO_PRODUCT);
    }
